...
export const paths = {
  ...
  dashboard: {
    ...
    recipeRecordPrint: (id: string) => `${ROOTS.DASHBOARD}/recipe-book/${id}/print`,
    services: `${ROOTS.DASHBOARD}/services`,
    serviceNew: `${ROOTS.DASHBOARD}/services/new`,
    service: (id: string) => `${ROOTS.DASHBOARD}/services/${id}`,
    servicePrint: (id: string) => `${ROOTS.DASHBOARD}/services/${id}/print`,
    ...
    kitchen: `${ROOTS.DASHBOARD}/kitchen`,
    kitchenNew: `${ROOTS.DASHBOARD}/kitchen/new`,
    kitchenLayout: (id: string) => `${ROOTS.DASHBOARD}/kitchen/${id}`,
